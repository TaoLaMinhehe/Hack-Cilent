...
import net.client.clickgui.Component;
import net.client.clickgui.components.BookOffersEditButton;
import net.client.hacks.autolibrarian.BookOffer;
import net.client.keybinds.PossibleKeybind;
import net.client.util.json.JsonException;
import net.client.util.json.JsonUtils;
import net.client.util.json.WsonObject;
import net.client.util.text.WText;
