...
import net.client.hacks.autolibrarian.UpdateBooksSetting;
import net.client.mixinterface.IKeyMapping;
import net.client.settings.BookOffersSetting;
...
import net.client.util.*;
import net.client.util.BlockBreaker.BlockBreakingParams;
import net.client.util.BlockPlacer.BlockPlacingParams;
