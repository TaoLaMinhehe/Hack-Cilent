...
import net.client.events.ChatInputListener;
import net.client.events.ChatOutputListener;
import net.client.hack.Hack;
import net.client.hacks.chattranslator.FilterOwnMessagesSetting;
import net.client.hacks.chattranslator.GoogleTranslate;
import net.client.hacks.chattranslator.LanguageSetting;
import net.client.hacks.chattranslator.LanguageSetting.Language;
import net.client.hacks.chattranslator.WhatToTranslateSetting;
