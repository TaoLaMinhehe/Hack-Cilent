...
import net.client.hacks.autocomplete.MessageCompleter;
import net.client.hacks.autocomplete.ModelSettings;
import net.client.hacks.autocomplete.OpenAiMessageCompleter;
import net.client.hacks.autocomplete.SuggestionHandler;
