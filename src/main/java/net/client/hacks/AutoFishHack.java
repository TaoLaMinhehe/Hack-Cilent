...
import net.client.hacks.autofish.AutoFishDebugDraw;
import net.client.hacks.autofish.AutoFishRodSelector;
import net.client.hacks.autofish.FishingSpotManager;
import net.client.hacks.autofish.ShallowWaterWarningCheckbox;
